...
# Use the newer `google.genai` client for Gemini access.
...
def ask_gemini(prompt):
    """Gemini থেকে উত্তর নেওয়ার ফাংশন"""
    if not client:
        return "Gemini client is not configured. Check google.genai installation and GEMINI_API_KEY."
